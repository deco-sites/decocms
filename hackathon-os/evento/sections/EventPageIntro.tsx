        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-8">
              ...
              <div class="prose max-w-none">
                <p class="text-gray-700 leading-relaxed mb-6">
                  {event.intro || "Este é um evento incrível onde você terá a oportunidade de criar soluções inovadoras, colaborar com pessoas talentosas e aprender muito!"}
                </p>
              ...
              <div class="grid md:grid-cols-2 gap-6">
                <div class="p-6 border border-gray-200 rounded-lg">
                  ...
                  <div class="mt-3 flex gap-2">
                    ...
                    <a href="#" class="text-gray-400 hover:text-gray-900">💻 GitHub</a>
                  </div>
                </div>
                <div class="p-6 border border-gray-200 rounded-lg">
                  <div class="flex items-center gap-4 mb-3">
            ...
            <div class="bg-white rounded-lg shadow-md p-8">
              ...
              <div class="space-y-4">
                <div class="border border-gray-200 rounded-lg p-6">
                  ...
                  <p class="text-gray-700 text-sm mb-3">Sistema de IA para análise de exames médicos usando visão computacional</p>
                  <div class="flex gap-2 text-sm">
                    <a href="#" class="text-purple-600 hover:underline">📺 Vídeo</a>
                    <a href="#" class="text-purple-600 hover:underline">💻 GitHub</a>
                    <a href="#" class="text-purple-600 hover:underline">📄 Apresentação</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          {currentTab === "classificacao" && (
            <div class="bg-white rounded-lg shadow-md p-8">
              ...
              <div class="space-y-3">
                {[
                  { position: 1, name: "AI Pioneers", project: "MediScan AI", score: 95, medal: "🥇", bg: "bg-yellow-50", border: "border-yellow-400" },
                  { position: 2, name: "Code Warriors", project: "SmartLearn", score: 88, medal: "🥈", bg: "bg-gray-50", border: "border-gray-400" },
                  { position: 3, name: "Tech Innovators", project: "AccessAI", score: 82, medal: "🥉", bg: "bg-orange-50", border: "border-orange-400" }
                ].map(item => (
              ...
              <p class="text-gray-500 italic text-center mt-8">Classificação final após avaliação dos jurados.</p>
            </div>
          )}
