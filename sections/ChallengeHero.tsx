...
export function Preview() {
  return (
    <ChallengeHero
      ...
      subtitle='Use este mês para criar uma solução real e concorrer a <strong class="text-white font-bold">2 MacBooks Air M3</strong>.'
      ctas={[
        { text: "Entregue seu projeto (em breve)", variant: "primary" },
        { text: "Ler as regras", variant: "secondary", opensRulesModal: true },
      ]}
