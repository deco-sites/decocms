...
export default function FinalCTACMS({
  title = "Give teams autonomy.\nKeep platform control.\nMake improvements compound.",
  primaryCtaText = "Explore MCP Mesh",
  primaryCtaUrl = "/mcp-mesh",
  secondaryCtaText = "Get Studio Early Access",
  secondaryCtaUrl = "/early-access",
}: Props) {
  const sectionId = `final-cta-cms-${Math.random().toString(36).substr(2, 9)}`;
          ...
          <div class="bg-[#D0EC1A] rounded-[20px] md:rounded-[40px] flex flex-col justify-center items-start overflow-hidden relative">
            ...
            <div class="w-full p-8 md:p-12 lg:p-20 flex flex-col lg:flex-row justify-start items-center gap-6 lg:gap-6 relative z-10">
              ...
              <div class="flex-1 flex flex-col justify-start items-start gap-6 lg:gap-10">
                <h2
                  class="w-full text-[#07401A] text-[40px] font-medium leading-tight whitespace-pre-line"
                >
                  {title}
                </h2>
              </div>
