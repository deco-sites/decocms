  ...
  return (
    <div class="min-h-screen bg-[#F1F0F6] relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto">
          <nav class="flex items-center justify-between">
            ...
            <div class="flex items-center">
              <div class="w-10 h-10 bg-[#D1EC1A] rounded-full flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path
                    d="M7 13.5C7 15.433 8.567 17 10.5 17C12.433 17 14 15.433 14 13.5C14 11.567 12.433 10 10.5 10C8.567 10 7 11.567 7 13.5Z"
                    fill="#07401A"
                  />
                  <path
                    d="M3.5 6.5C3.5 8.433 5.067 10 7 10C8.933 10 10.5 8.433 10.5 6.5C10.5 4.567 8.933 3 7 3C5.067 3 3.5 4.567 3.5 6.5Z"
                    fill="#D1EC1A"
                  />
                </svg>
              </div>
            ...
            <div class="hidden md:flex items-center space-x-2 bg-[#E7E5E4] rounded-2xl p-1">
              <button class="px-4 py-1.5 text-sm text-[#28251F] rounded-full">
                Apps
              </button>
              <button class="px-4 py-1.5 text-sm text-[#28251F] rounded-full">
                Use Cases
            ...
            <div class="w-8 h-8 relative">
              <div class="absolute inset-0 grid grid-cols-4 gap-0.5">
                {Array.from({ length: 16 }).map((_, i) => (
                  <div key={i} class="w-0.5 h-0.5 bg-[#D1EC1A] rounded-full">
                  </div>
                ))}
              </div>
            </div>
      ...
      <section class="relative z-10 bg-[#FAFAF9] px-4 py-20">
        <div class="max-w-7xl mx-auto">
          <div class="text-center mb-12">
            <h2 class="text-lg font-bold text-black mb-6">
              From videocoding builds to enterprise scale.
            </h2>
            <div class="flex flex-wrap justify-center items-center gap-8 opacity-60">
              {/* Company logos would go here - using placeholder for now */}
              <div class="w-32 h-12 bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500">
                Logo 1
              </div>
              <div class="w-32 h-12 bg-gray-200 rounded flex items-center justify-center text-xs text-gray-500">
                Logo 2
        ...
        <div class="max-w-7xl mx-auto">
          <div class="text-center mb-16">
            <h2 class="text-5xl font-medium text-[#1C1917] mb-6">
              The control plane that turns AI prototypes into
              production—governed, observable, and cost-clear.
            </h2>
          </div>
          ...
          <div class="grid lg:grid-cols-2 gap-6">
            ...
            <div class="bg-[#F1F0F6] rounded-xl p-8 lg:p-12">
              <div class="mb-8">
                <h3 class="text-4xl font-medium text-[#28251F] mb-6">
                  Connect your context
                </h3>
                <p class="text-2xl text-[#78716C] leading-relaxed">
                  Unify data, tools and models with policy, RBAC and
                  observability — your agents always get the right context,
                  safely.
                </p>
              </div>
              <div class="space-y-2">
                <div class="bg-[#FAFAF9] rounded-xl p-4">
                  <span class="text-lg text-[#1C1917]">
                    MCP-native connectors
                  </span>
                </div>
                <div class="bg-[#E7E5E4] rounded-xl p-4">
                  <span class="text-lg text-[#78716C]">
                    Policy routing & RBAC
                  </span>
                </div>
                <div class="bg-[#E7E5E4] rounded-xl p-4">
            ...
            <div class="bg-[#F1F0F6] rounded-xl p-8 lg:p-12">
              <div class="mb-8">
                <h3 class="text-4xl font-medium text-[#28251F] mb-6">
                  Prototype in chat, ship in code. Same repo.
                </h3>
                <p class="text-2xl text-[#78716C] leading-relaxed">
                  Ship agents, workflows and views in the same runtime:
                  TypeScript SDK, typed RPC and edge deploy.
                </p>
              </div>
              <div class="space-y-2">
                <div class="bg-[#E7E5E4] rounded-xl p-4">
                  <span class="text-lg text-[#78716C]">
                    Chat → Code prototyping
                  </span>
                </div>
                <div class="bg-[#FAFAF9] rounded-xl p-4">
            ...
            <div class="bg-[#F1F0F6] rounded-xl p-8 lg:p-12">
              <div class="mb-8">
                ...
                <p class="text-2xl text-[#78716C] leading-relaxed">
                  No vibe debugging: logs, traces, error analytics and
                  cost-per-step to optimize quality and spend, with roles,
                  approvals and tenancy.
                </p>
              </div>
              <div class="space-y-2">
                <div class="bg-[#FAFAF9] rounded-xl p-4">
            ...
            <div class="bg-[#F1F0F6] rounded-xl p-8 lg:p-12">
              <div class="mb-8">
                ...
                <p class="text-2xl text-[#78716C] leading-relaxed">
                  Install ready-made modules — or publish your own. Wallet-based
                  per-run billing turns apps into revenue.
                </p>
              </div>
              <div class="space-y-2">
                <div class="bg-[#FAFAF9] rounded-xl p-4">
      ...
      <section class="bg-[#FAFAF9] px-4 py-20">
        <div class="max-w-7xl mx-auto">
          <div class="text-center mb-16">
            <h2 class="text-5xl font-medium text-[#28251F] mb-6">
              One platform, two surfaces
            </h2>
            <p class="text-lg text-[#78716C]">
              Prototype in natural language. Scale in code.
            </p>
          </div>
          ...
          <div class="grid lg:grid-cols-2 gap-4">
            ...
            <div class="bg-[#F1F0F6] rounded-xl p-8">
              ...
              <h3 class="text-3xl text-[#28251F] mb-4">
                ...
                <div class="w-6 h-6 mb-4">
                  <div class="grid grid-cols-4 gap-0.5">
                    {Array.from({ length: 16 }).map((_, i) => (
                      <div
                        key={i}
                        class="w-0.5 h-0.5 bg-[#8CAA25] rounded-full"
                      >
                      </div>
                    ))}
                  </div>
                </div>
                <h4 class="text-2xl text-[#28251F] mb-2">
      ...
      <section class="bg-[#FAFAF9] px-4 py-20">
        <div class="max-w-7xl mx-auto">
          <div class="mb-16">
            <h2 class="text-5xl font-medium text-[#28251F] mb-12 max-w-2xl">
              Take a look inside the Agentic Era
            </h2>
          ...
          <div class="grid lg:grid-cols-3 gap-6">
            {Array.from({ length: 3 }).map((_, i) => (
              <article key={i} class="bg-[#F1F0F6] rounded-xl overflow-hidden">
                ...
                <div class="p-8">
                  <h3 class="text-3xl text-[#28251F] mb-6">
                    Build & compose all in one single repository
                  </h3>
                  <p class="text-xl text-[#78716C] mb-8 leading-relaxed">
                    Ship agents, workflows and views in the same runtime:
                    TypeScript SDK, typed RPC and edge deploy. Prototype in
                    chat, ship in code.
                  </p>
            ...
            {[
              ...
              <div key={i} class="border-b border-gray-200">
                <button class="w-full flex items-center justify-between py-6 text-left">
                  <span class="text-xl font-medium text-[#544F4A]">
                    {question}
                  </span>
                  ...
                  <div class="pb-6">
                    <div class="bg-[#07401A] text-[#D1EC1A] p-6 rounded-2xl">
                      <p class="text-xl font-medium">
                        deco.chat is an open-source AI workspace that helps
                        organizations build and manage AI agents. It's designed
                        to make AI implementation simple, whether for internal
                        tools or customer-facing applications.
                      </p>
                    </div>
                  </div>
                )}
      ...
      <section class="bg-[#D1EC1A] px-4 py-20 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto text-center relative z-10">
          <div class="mb-12">
            <h2 class="text-5xl font-medium text-[#07401A] mb-6">
              Be one of the first to use the new
            </h2>
            <p class="text-lg text-[#07401A] mb-10">
              Join the waiting list to gain early access to the platform that
              will transform how you create online stores.
            </p>
      ...
      <footer class="bg-[#07401A] px-4 py-20">
        <div class="max-w-7xl mx-auto">
          <div class="grid md:grid-cols-4 gap-12 mb-16">
            {/* Solutions */}
            <div>
              <h3 class="text-lg font-semibold text-[#D1EC1A] mb-6">
                Solutions
              </h3>
              <ul class="space-y-4">
                <li>
                  <a
                    href="#"
                    class="text-[#D6D3D1] hover:text-[#D1EC1A] transition-colors"
                  >
                    AI Agents
                  </a>
                </li>
          ...
          <div class="border-t border-[#D6D3D1] pt-8">
            <img
              src={companyLogo}
              alt="Company logos"
              class="w-full h-48 object-contain opacity-60"
            />
          </div>
        </div>
      </footer>
