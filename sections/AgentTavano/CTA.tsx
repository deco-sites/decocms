...
export default function CTA({
  ...
  description =
    "Experimente o Agent Tavano e descubra como a inteligência artificial pode transformar seu negócio digital.",
  ...
  return (
    <section class="py-20 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
      ...
      <div class="absolute inset-0">
        <div class="absolute top-10 left-10 w-20 h-20 bg-primary/10 rounded-full blur-xl animate-pulse">
        </div>
        <div class="absolute bottom-10 right-10 w-32 h-32 bg-primary/5 rounded-full blur-2xl animate-pulse delay-1000">
        </div>
        <div class="absolute top-1/2 left-1/4 w-16 h-16 bg-primary/10 rounded-full blur-lg animate-pulse delay-500">
        </div>
      </div>
      ...
      <div class="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <div class="mt-12 flex justify-center">
          <div class="flex space-x-2">
            <div class="w-3 h-3 bg-primary/30 rounded-full animate-bounce">
            </div>
            <div class="w-3 h-3 bg-primary/50 rounded-full animate-bounce delay-100">
            </div>
            <div class="w-3 h-3 bg-primary/70 rounded-full animate-bounce delay-200">
            </div>
          </div>
        </div>
      </div>
