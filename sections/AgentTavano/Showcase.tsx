...
export default function Showcase({
  ...
  subtitle =
    "Exemplos reais de como o Agent Tavano transforma ideias em código funcional",
  items = [],
}: Props) {
  return (
            ...
            >
              ...
              <div class="flex-1">
                <div class="relative group">
                  ...
                  {/* Overlay effect */}
                  <div class="absolute inset-0 bg-gradient-to-t from-primary/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="mt-20 text-center">
          <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
            ...
            <p class="text-gray-600 mb-6">
              Experimente o Agent Tavano e transforme suas ideias em realidade
              digital
            </p>
            <a
              href="#contact"
