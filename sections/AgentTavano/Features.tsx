      ...
      <div class="max-w-7xl mx-auto px-4">
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div class="absolute bottom-0 left-0 right-0 h-1 bg-gray-100">
                <div class="h-full bg-primary transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-left">
                </div>
              </div>
            </div>
          ))}
        ...
        <div class="mt-20">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div class="group">
              <div class="text-3xl font-bold text-primary mb-2 group-hover:scale-110 transition-transform duration-300">
                10x
              </div>
