...
export default function Context({
  ...
  subtitle = "O Agent Tavano conhece profundamente todos os aspectos da sua operação",
  contextItems = []
}: Props) {
  return (
        ...
        <div class="mt-20 text-center">
          <div class="relative">
            <div class="flex justify-center items-center space-x-4 mb-8">
              ...
              <div class="w-16 h-0.5 bg-gradient-to-r from-primary to-primary/30"></div>
              <div class="w-4 h-4 bg-primary/60 rounded-full animate-pulse delay-300"></div>
              <div class="w-16 h-0.5 bg-gradient-to-r from-primary/30 to-primary"></div>
              <div class="w-3 h-3 bg-primary rounded-full animate-pulse delay-600"></div>
            </div>
