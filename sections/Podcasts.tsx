    ...
    switch (name.toLowerCase()) {
      case "apple":
        return (
          ...
          >
            <path
              d="M28.0156 29.1847C26.9115 30.8342 25.7409 32.4437 23.9584 32.4703C22.1759 32.5102 21.6039 31.4195 19.582 31.4195C17.5467 31.4195 16.9215 32.4437 15.2321 32.5102C13.4895 32.5768 12.1726 30.7544 11.0552 29.1448C8.7805 25.8591 7.03791 19.8066 9.3791 15.7361C10.5364 13.7142 12.6115 12.4372 14.8596 12.3973C16.5624 12.3707 18.1852 13.5546 19.2361 13.5546C20.2737 13.5546 22.2424 12.1312 24.3043 12.344C25.1689 12.384 27.5899 12.6899 29.1463 14.9779C29.0266 15.0577 26.2597 16.6806 26.2863 20.046C26.3262 24.0633 29.8114 25.4069 29.8513 25.4202C29.8114 25.5133 29.2926 27.3357 28.0156 29.1847ZM20.42 7.9011C21.3911 6.79701 23.0006 5.95897 24.3309 5.90576C24.5038 7.46212 23.8786 9.03179 22.9474 10.1492C22.0296 11.2799 20.5131 12.1578 19.0233 12.0381C18.8237 10.5083 19.5687 8.91207 20.42 7.9011Z"
              fill="#282524"
            />
          </svg>
        );
            ...
            <defs>
              <clipPath id="clip0_1068_1374">
                <rect
                  ...
                  height="21.5837"
                  fill="white"
                  transform="translate(-0.00585938 0.41748)"
                />
              </clipPath>
            </defs>
          </svg>
      ...
      default:
        return (
          ...
          >
            <path
              d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-2-8c0-.55-.45-1-1-1s-1 .45-1 1 .45 1 1 1 1-.45 1-1zm6 0c0-.55-.45-1-1-1s-1 .45-1 1 .45 1 1 1 1-.45 1-1z"
              fill="currentColor"
            />
          </svg>
        );
